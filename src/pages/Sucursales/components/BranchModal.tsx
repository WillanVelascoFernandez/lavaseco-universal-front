...
export const BranchModal: React.FC<BranchModalProps> = ({ isOpen, onClose, branch, onUpdatePrices }) => {
    ...
    const confirmSave = (applyToAll: boolean) => {
        onUpdatePrices(branch.id, wPrice, dPrice, applyToAll);
        onClose();
    };
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                        ...
                                        <div className="text-xl font-bold text-brand-dark leading-none">{branch.totalWashes.toLocaleString()}</div>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                        <div className="flex items-center gap-2 mb-1">
                                            <Wind size={14} className="text-brand-accent" />
                                        ...
                                        <div className="text-xl font-bold text-brand-dark leading-none">{branch.totalDries.toLocaleString()}</div>
                                    </div>
                                </div>
                            </div>
