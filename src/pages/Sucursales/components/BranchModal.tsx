                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                        ...
                                        <div className="text-2xl font-black leading-none">{branch.totalWashes.toLocaleString()}</div>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                        <div className="flex items-center gap-2 mb-1">
                                            <Wind size={14} className="text-brand-accent" />
                                        ...
                                        <div className="text-2xl font-black leading-none">{branch.totalDries.toLocaleString()}</div>
                                    </div>
                                </div>
                            </div>
